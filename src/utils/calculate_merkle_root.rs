...
mod test {
    ...
    fn test_calculate_merkle_root() {
        ...
        let res = calculate_merkle_root(vec![Hash256::new(
        ...
        let v = vec![
            Hash256::new(
                &hex::decode("3346c19af961c9107bdd1ca8ed477165dedd56e2a5c911512521c09827d94311")
                    .unwrap(),
            ),
            Hash256::new(
                &hex::decode("b6665bee6da789001f6d99296c226315cb0c7413e5669579add27198aec5516e")
                    .unwrap(),
            ),
            Hash256::new(
                &hex::decode("abf7af6c442cc2953aa0247dc17c740c4d64af5117ad502a805e994d3d3a11f8")
                    .unwrap(),
            ),
            Hash256::new(
                &hex::decode("4a0ab9b04b87e717c0e5c18cd6391c35cc27525ddca2e96adae75c4d71b2dc07")
                    .unwrap(),
            ),
        ];
        assert_eq!(
            calculate_merkle_root(v),
            Hash256::new(
                &hex::decode("f7ff6732787f00803829e73bf8bccdc2f39cd69ac21ffa04e7ab63c1ce11a536")
                    .unwrap()
            )
        );
