...
mod test {
    use super::*;
    //macro test helpers
    use crate::types::{Bytes, Hash256, Witness};
    ...
    fn test_parse_transaction() {
        ...
        let data = include_bytes!(
            "../test_data/tx_640d0279609c9047ebbffb1d0dcf78cbbe2ae12cadd41a28377e1a259ebf5b89.bin"
        );
        let (_, tx) = parse_transaction(data).unwrap();
        assert_eq!(
            tx.txid,
            Hash256::new(
                &hex::decode("895bbf9e251a7e37281ad4ad2ce12abecb78cf0d1dfbbfeb47909c6079020d64")
                    .unwrap()
            )
        );
        assert_eq!(
            tx.wtxid,
            Hash256::new(
                &hex::decode("ab1fefe700cd871d759bd8c7f77438e4561374dd1397e17e7526d48eeb44d430")
                    .unwrap()
            )
        );
        ...
        assert_eq!(
            tx.txid,
            Hash256::new(
                &hex::decode("b810813280f55601bb994b62ec0f13f9fd11bc82cfe73b02e79d970f46147282")
                    .unwrap()
            )
        );
        assert_eq!(
        ...
        test_output!(
            outputs[0],
            194000000,
            "76a9146be6bb0554c1f482c529d018de7da3b039b5ec1188ac"
        );
        test_output!(
            outputs[1],
            1000000,
            "76a914e110891bfbb319c04762169d3885203b6eb9a25288ac"
        );

        let data = include_bytes!(
            "../test_data/tx_982e0cea72b4f599e09f3556d649518608385fcf269e811fa7ed51d7e4f5241c.bin"
        );
        let (_, tx) = parse_transaction(data).unwrap();
        assert_eq!(
            tx.txid,
            Hash256::new(
                &hex::decode("1c24f5e4d751eda71f819e26cf5f3808865149d656359fe099f5b472ea0c2e98")
                    .unwrap()
            )
        );
        assert_eq!(
            tx.wtxid,
            Hash256::new(
                &hex::decode("8cbc8c76ba2a594cc1056e5446e6cbb85eb82fd573faa726caa788aaae5b1ca2")
                    .unwrap()
            )
        );
        ...
        test_input!(
            &inputs[0],
            "63974dced933b0885531c6cd16b81832465b3ea4d266437afbce6edf6f1dd0e4",
            31,
            "160014c3447428dee50d786fea673c6a0fc32f665a3da8",
            4294967293
        );
        ...
        test_output!(
            outputs[0],
            212948850,
            "76a914d89793719a269a2bb180886a95d3a5d83c3adc8888ac"
        );
        test_output!(
            outputs[1],
            19332281,
            "a9142c90f403bd58916e85ec98b3c4f9ba7dc0e4e76e87"
        );
        ...
        test_witness!(
            &witnesses_n[1],
            "02d1c1634a5f48c59ffda1e453a0286fce38514140b63aec09c35c3f4ffa0756bb"
        );
        ...
        assert_eq!(
            tx.txid,
            Hash256::new(
                &hex::decode("6577b12f82f654a1de16f6c861397c27c61dc0766057bfca9ce0270b8ef9489e")
                    .unwrap()
            )
        );
        assert_eq!(
            tx.wtxid,
            Hash256::new(
                &hex::decode("fa8bf120eb70ac07e8520f56536dcc9e4c0f1f7c1db8036c202c73d3a8c6fe00")
                    .unwrap()
            )
        );
        assert_eq!(tx.version, 2);
        ...
        test_input!(
            &inputs[0],
            "00114b16b5fe1251ee3e995b4dacdd68a815e57978511cda8fd30a79ab414f8b",
            0,
            "16001403fa4c9e95ee6b8863220374db0397b4e52a1a62",
            4294967295
        );
        test_input!(
            &inputs[1],
            "e442053bee8f18134cf7d67227ae225e8fd547b1ff7e069d1614763d3836e09a",
            25,
            "160014727bc58035613ba0ef41239626d6921c56796f59",
            4294967295
        );
        test_input!(
            &inputs[2],
            "a9f5983dca1b661ad298eab8e414d5d97409145b9b52522767b2ade551cb0772",
            56,
            "160014afa1688ec93089773cd42574c438b852148a75e3",
            4294967295
        );
        test_input!(
            &inputs[3],
            "e320afe366dc3f09f3fd5f1310dbf01090f0de07748ccf5c912c93301f23b28a",
            0,
            "1600146f840b4216907270f7b9e02499aea0d342ca5df7",
            4294967295
        );
        test_input!(
            &inputs[4],
            "3442ae2122a3c4789e1c7426db81e404e48e413a203bca02334354993b72b2c3",
            6,
            "160014c286b328eae6566dd32559df04c00a73d3e93e56",
            4294967295
        );
        test_input!(
            &inputs[5],
            "3f37453fe733f34e33ece620c2c74e803ca83a0ebbe58965082cdf4380ca7f3a",
            23,
            "160014103bd1496525e7871295d0b4414e790a9f34fdd8",
            4294967295
        );
        test_input!(
            &inputs[6],
            "9ae8ff52416cfc03e0954372c5bc9a5caaca01c52626176486f736208dda5752",
            0,
            "160014609ebfe943ea2adca3054e018b4bddd213615cf3",
            4294967295
        );
        test_input!(
            &inputs[7],
            "c518909f344f0c9f72ccd88bfa43e82bdd68d16e376842f4ffea9f49372db830",
            1,
            "1600144683c3d669e4dc873fc07d95b6360c7eb35d250e",
            4294967295
        );
        test_input!(
            &inputs[8],
            "7f9a81b14794c6acd63a7b859754e87059def91e4f417e1841e25fa71f6a5cec",
            10,
            "160014621db2b20233233c9fb97b614df01e9eeacc376b",
            4294967295
        );
        test_input!(
            &inputs[9],
            "a8c183e053fd3f57b48346955623b4a56f1a57d19c291512fcbc611c03ce4839",
            13,
            "16001421ad97c14a8ccc7a5f1b48992dd524ffc0a2b4f4",
            4294967295
        );
        test_input!(
            &inputs[10],
            "70582a5194b35bb731e462684a3ad6125dfa64a7b54da216f956ba2311c67698",
            5,
            "160014588621703846a8e98861b9c74dab0e959e5dea71",
            4294967295
        );
        test_input!(
            &inputs[11],
            "5f2f8e75054e3de9e3d8445174c12db7ec3854720dcc18578ab01b65bfeac618",
            17,
            "160014d88f122ffb37b3c491ba6d338dfe383390578207",
            4294967295
        );
        test_input!(
            &inputs[12],
            "4d2f4d68775c3b295ecf2a60fc439cfb17da1ea01f3bc0b92137eb93b2fef6a6",
            0,
            "16001413bba8944bd92eab2dbbd10621b73bc22cffbcbc",
            4294967295
        );
        test_input!(
            &inputs[13],
            "6d0c038229f588ed9ee8c25590b3271b4c30a55d8e965bb7a000945e1562446e",
            3,
            "160014fedd82c1a95b2d7c304b3c91f49a2426456f503e",
            4294967295
        );
        test_input!(
            &inputs[14],
            "6de9c43ff56ec3b3abb1a4419c6ec447dbbcf8eed11b22ee26d12c87abe2e3b9",
            0,
            "16001468fc848137d7d07df1ac531689d0b0cc20e0ad70",
            4294967295
        );
        test_input!(
            &inputs[15],
            "041b1d7b083ea53dad2b7f666a8b839cdbc08b2100e430411e4fcd4500fb91b4",
            0,
            "160014d5f5014f9453c0c30f7a9e68dd1d341c72b925e3",
            4294967295
        );
        test_input!(
            &inputs[16],
            "e320afe366dc3f09f3fd5f1310dbf01090f0de07748ccf5c912c93301f23b28a",
            6,
            "1600141e05072012c3d9dee70a0b26c148814acbf9732d",
            4294967295
        );
        test_input!(
            &inputs[17],
            "612c171a1fd0a779232609361696a2b5aee21805d39a7c96632c8a9d577823e1",
            2,
            "1600143e3b52fbfa68d340bdcb224e0401a0bde7139c2b",
            4294967295
        );
        test_input!(
            &inputs[18],
            "6ae9a523259f51b15c611bf97f60fe721576a4483b31a69a3e34026d2f7f5052",
            0,
            "160014622f8f19af87a47db37bf4f1b1cfdfa6f67e7c9e",
            4294967295
        );
        test_input!(
            &inputs[19],
            "34d89e7ad61d975de9c4b263a682ad3e5017de4d4911c4f7353db3721b29f01b",
            17,
            "160014339baaaec1b3967baf81ca597b82e2ffbb47d74b",
            4294967295
        );
        test_input!(
            &inputs[20],
            "b5e1a1336f62314e4d23ed1114277c0599ebb81859bb6176b2422513a82c7306",
            7,
            "160014ed1d6db6328af2355f72063e92cd0c0c0e1190ab",
            4294967295
        );
        test_input!(
            &inputs[21],
            "f7d27d533eb240a31b5f55568c060195d0fb258951f893ed17ff5722818a66a3",
            0,
            "1600143ef31046d066525a1ddc1ac7f8eb754089aa0dc2",
            4294967295
        );
        test_input!(
            &inputs[22],
            "3712edd101cd481ea3bf125f0e08e826dcb682b80150a54f308d347678dcc654",
            1,
            "1600142be2af7e083b4157e4882ffd7763ce4d9530ec2d",
            4294967295
        );
        test_input!(
            &inputs[23],
            "33819ccc8bb7cafad4a8a5a4fed576ddd993210c868fc5338c25299c3ca68f98",
            3,
            "160014993ac4ea5060d86fd947bbf99fe29f68c3f05d15",
            4294967295
        );
        test_input!(
            &inputs[24],
            "c09ca095b364290a6cb7cb2c3d42c1ae3759d1286226d3edc20f75abcbb987fc",
            6,
            "160014734750f47db08c3df0c96504089e686142d02c6d",
            4294967295
        );
        test_input!(
            &inputs[25],
            "1648667c00f8686cec7c6dd2f5064fba8436a5ccf0cd5e6cd5b63069975d16e5",
            3,
            "16001468ffe74657fc33ffdc0a380efacbad637361eb74",
            4294967295
        );
        ...
        test_output!(
            outputs[0],
            1000000,
            "a9149eedb19fe75f95ec54543ff73cafaaf0c52c37eb87"
        );
        test_output!(
            outputs[1],
            285799,
            "76a914b25726349fbe21cc2976efb871efcd7cc444cb0988ac"
        );
        test_output!(
            outputs[2],
            433200,
            "a91442ad19bcd23b4eae8ec665f7af84b16325167b6487"
        );
        test_output!(
            outputs[3],
            32272348,
            "76a914d58221209badcf0c62e47b388ce34866a3563d9688ac"
        );
        test_output!(
            outputs[4],
            545000,
            "76a914c75a85be774e4dfdbbcd755be18c63b5f3e0e4bd88ac"
        );
        test_output!(
            outputs[5],
            100000,
            "76a9148354f623991b341646e7f2ec0eb2f780c83c2a0788ac"
        );
        test_output!(
            outputs[6],
            3333000,
            "a9149730cf919cfc249a61bec8af3266622c5da9fa3187"
        );
        test_output!(
            outputs[7],
            15247342,
            "76a914a7d7f17a4ead33468a20ad5cf26b17a7bc896a0188ac"
        );
        test_output!(
            outputs[8],
            10877580,
            "a91417ba68e3977d75bf87bcd3d475ed003e5a253d7187"
        );
        test_output!(
            outputs[9],
            1034933,
            "a9146b7951bf7d165df60f4b92f8bb2eebf3d91369bf87"
        );
        ...
        test_witness!(
            &witnesses_n[1],
            "0343a3c7c5edb72fd20cfcdca0d42b11cd718bd254bff4887fa276a4fde6836c3a"
        );
        let witnesses_n = &witnesses[1];
        ...
        test_witness!(
            &witnesses_n[1],
            "02d9b90d8dae4a54250616d06ead838a6dd2f8e977efc0118b46b4e1ede1918ba3"
        );
        let witnesses_n = &witnesses[2];
        ...
        test_witness!(
            &witnesses_n[1],
            "0396acb01d48f5f5d087efff3d759b0532058f5a87e6a1abd6d5521cad977f401b"
        );
        let witnesses_n = &witnesses[3];
        ...
        test_witness!(
            &witnesses_n[1],
            "03edf1e2ba356dd932f64d40fb1e459f482e451eadf858a79711d3b23b1054e2fa"
        );
        let witnesses_n = &witnesses[4];
        ...
        test_witness!(
            &witnesses_n[1],
            "0331795e2e29c00d5418b6be2289d3a3ad41490e17d1c8158596e1d42f0dbe6cff"
        );
        ...
        test_witness!(
            &witnesses_n[1],
            "0332990ab3fe323c8f0f25c676d794a4428062523a4c951cfe3a107544cb143a88"
        );
        ...
        test_witness!(
            &witnesses_n[1],
            "02edfe3a48594a08a6f310f964a373d0b3dc680478083209f042bb704ce8102576"
        );
        ...
        test_witness!(
            &witnesses_n[1],
            "02e69d14451661ffd1d6327baf7e8d5b5b1d43012f95334f803444d27e67cd7f0a"
        );
        ...
        test_witness!(
            &witnesses_n[1],
            "02224c0099aae82953670b9bbdc936ee2a26f7d3b538a1016712fdfae8af6141d7"
        );
        ...
        test_witness!(
            &witnesses_n[1],
            "03759afb6d80611b6777befab845b663414c8a703456f3fbc58d6adbdd42e1a909"
        );
        ...
        test_witness!(
            &witnesses_n[1],
            "02a337ce8f564421b93a517328426916ca64d27c2258475c98927d82cfd72db933"
        );
        ...
        test_witness!(
            &witnesses_n[1],
            "03dfb2f185226af48a2cd0e44a9d3c198918a117639df87e001d1048365a109af9"
        );
        ...
        test_witness!(
            &witnesses_n[1],
            "023c2b15c0f755986ec4a34eb1ce4a1ebcab747c34f4bd245b787f3285af166101"
        );
        ...
        test_witness!(
            &witnesses_n[1],
            "02933be19b4fec88b0d76116d86bc96a4d0422be0d3873f402a618a9a9c764bde4"
        );
        ...
        test_witness!(
            &witnesses_n[1],
            "03df6a959b7d4f00e1e80cbb2009bfe360e52f9de6166d61e647bd29164f12a633"
        );
        ...
        test_witness!(
            &witnesses_n[1],
            "0379f3b349fe60faed0bfc88ec6786c66fa9acff3b4b14d2b3e8328cda4ded8b38"
        );
        ...
        test_witness!(
            &witnesses_n[1],
            "03152c416f1acbe367f78fe9bc2ee931c79a0ca739a56c5b3bca38e00d54c74352"
        );
        ...
        test_witness!(
            &witnesses_n[1],
            "035299a12a9e259d3fb9eeab3a47ee63cf73d88f2fd52203753e54d1c7d126c722"
        );
        ...
        test_witness!(
            &witnesses_n[1],
            "0396351c862b362109637727ee03d6f1dba0fbd205b53a6f389e512fc67cbd96b3"
        );
        ...
        test_witness!(
            &witnesses_n[1],
            "032a199f5d5c463fe15287afbb51f96f6bff7b8464f3c16f2be1b02e44a85aad44"
        );
        ...
        test_witness!(
            &witnesses_n[1],
            "02ea1e28d10f0795393ba983059171ffed19a892d83433f087073333237ca416b5"
        );
        ...
        test_witness!(
            &witnesses_n[1],
            "03420c0d3dabfa6ac17c82f3a66fcd17e9f19e852b2e72721c9a6af96395b87e58"
        );
        ...
        test_witness!(
            &witnesses_n[1],
            "038daabf8643d7e6728a2c5b28e3a7fe551e2d5e55c8a63b6a6559f82474f677d7"
        );
        ...
        test_witness!(
            &witnesses_n[1],
            "0370b1c452105b1818fd328bbb828f95c965f42a626122d52de0483aa6532a0c9e"
        );
        ...
        test_witness!(
            &witnesses_n[1],
            "02f7e21abca976847a287855394bc49a6395b8c33e95ce08e0715ab7490998d89e"
        );
        ...
        test_witness!(
            &witnesses_n[1],
            "03e1fdf492d6a179219ced7ec684ecccda207b841cd035b31427e7a34012719cb1"
        );

        let data = include_bytes!(
            "../test_data/tx_c623634f506375a45ee09379d4b117d5ddb1d02eb04c257d9354cbf0055ad191.bin"
        );
        let (_, tx) = parse_transaction(data).unwrap();
        assert_eq!(
            tx.txid,
            Hash256::new(
                &hex::decode("91d15a05f0cb54937d254cb02ed0b1ddd517b1d47993e05ea47563504f6323c6")
                    .unwrap()
            )
        );
        assert_eq!(
            tx.wtxid,
            Hash256::new(
                &hex::decode("2776bbc43da932c584c20ef47b64e1e00a767520a90ae0d20c35535be47dde89")
                    .unwrap()
            )
        );
        assert_eq!(tx.version, 2);
        ...
        test_input!(
            &inputs[0],
            "3882466f2f3e2b3de06354c0fea17b0000ce3fa6ce9698a33c5ec966a7b466a1",
            0,
            "1600144e2f27e5c2e25195634c7713f691f1d482cfdc45",
            4294967294
        );
        test_input!(
            &inputs[1],
            "bedb62ebc3dcbef593b3671c583ffc35206e9f9e65ca39a3590383eaae619265",
            0,
            "1600149a67952f08c8ca8b648760cc07fbfa1a554615a6",
            4294967294
        );
        ...
        test_input!(
            &inputs[3],
            "f387b4ecfab822ba6387903e346533586c3e4818ca75f8eec9811a09ae380456",
            0,
            "1600140736c01aa95363f463f747387eec9157884e2de9",
            4294967294
        );
        ...
        test_output!(
            outputs[0],
            895431,
            "a914064b4245fa5d570c81812448d131ae52f94b1a1787"
        );
        test_output!(
            outputs[1],
            12680000,
            "a91484da2a5170dc3d945e7977aed42011d05105505487"
        );
        test_output!(
            outputs[2],
            19170448,
            "a914938900677f255ebd62d301a96a8470262791136287"
        );
        ...
        test_witness!(
            &witnesses_n[1],
            "028b3f127bd412556d78663d8bdbd4277b0510663c7e10778aa4bd91f88db95cfd"
        );
        let witnesses_n = &witnesses[1];
        ...
        test_witness!(
            &witnesses_n[1],
            "03d1d0afa87be50294b633a7c7d9e33a523b5003fea45cfda8f715bffc80d66358"
        );
        let witnesses_n = &witnesses[2];
        test_witness!(&witnesses_n[0], "");
        let witnesses_n = &witnesses[3];
        ...
        test_witness!(
            &witnesses_n[1],
            "03a7bcc6fff744df14fd716c712cef7dd6443d9e75851085ec4f33dafcc7772f63"
        );
        ...
        assert_eq!(
            tx.txid,
            Hash256::new(
                &hex::decode("321d9474322e0bbc9562a5e6d5a62069bc392c1c43a964744c6b78b1415c42d1")
                    .unwrap()
            )
        );
        assert_eq!(
            tx.wtxid,
            Hash256::new(
                &hex::decode("0c8b5575031256eff14e91d65d86acfeb99e0ce55c7b080868e00d5224c00361")
                    .unwrap()
            )
        );
        assert_eq!(tx.version, 2);
        ...
        test_output!(
            outputs[0],
            5000000000,
            "a914c23b2cb101848e7e73459bdfcb9796c1154c25ee87"
        );
        test_output!(
            outputs[1],
            0,
        ...
        assert_eq!(
            tx.txid,
            Hash256::new(
                &hex::decode("8c5d78c65cd6209d7ebb1e6af6e7f9f0fddc9869c8b6f4b52be50ba829af06de")
                    .unwrap()
            )
        );
        assert_eq!(
            tx.wtxid,
            Hash256::new(
                &hex::decode("0d7a81fb2c608a663c0b3491d1fdd93edff7d99f5583a7789b61b964d5730bb5")
                    .unwrap()
            )
        );
        assert_eq!(tx.version, 1);
        ...
        test_input!(
            &inputs[0],
            "aea7e39ca42c33e20d5cb86e4a07a5607947275a1ea8bcbfde4d94bc1259d458",
            4,
            "",
            4294967295
        );
        ...
        test_output!(
            outputs[0],
            12000000,
            "76a9141b6517e189434cf8f18cc38ceb88c8fdce25b8f188ac"
        );
        test_output!(
            outputs[1],
            6802757,
        ...
        let data = include_bytes!(
            "../test_data/tx_e73781944bc6624acf0a8ebcefa9c25046cdda8dc7ad962bb0c41bcd302f9ca5.bin"
        );
        let (_, tx) = parse_transaction(data).unwrap();
        assert_eq!(
            tx.txid,
            Hash256::new(
                &hex::decode("a59c2f30cd1bc4b02b96adc78ddacd4650c2a9efbc8e0acf4a62c64b948137e7")
                    .unwrap()
            )
        );
        assert_eq!(
            tx.wtxid,
            Hash256::new(
                &hex::decode("32031301ed7082726712efb99523a493a7b722dbda2e28eb2034a0168639a04a")
                    .unwrap()
            )
        );
        assert_eq!(tx.version, 1);
        ...
        test_input!(
            &inputs[6],
            "cf395d656f71815c7f006c02a9f001712f63ac7654a80170ef842ca189431085",
            7,
            "",
            4294967295
        );
        test_input!(
            &inputs[7],
            "55d4194521f3d39bfa8421ff0334369f560f66604a276a363d26669d97407a8a",
            9,
            "",
            4294967295
        );
        ...
        test_output!(
            outputs[0],
            278100000,
            "a914f938ef06b17f94f8943decc2de530191b8db1c3087"
        );
        test_output!(
            outputs[1],
            5000000000,
            "a914ba152510537e52bae0f0f45f0d91a81a17d4d02987"
        );
        test_output!(
            outputs[2],
            1000000,
            "76a9142fd4c4f8e61ccf9d4c9967d415bdbaeffc2a3fdc88ac"
        );
        test_output!(
            outputs[3],
            109500000,
            "a91468126269aa368cf0bfa730afcae1aec5909b0a8487"
        );
        test_output!(
            outputs[4],
            7588390042,
            "0020dca044867d191815d2e0a34b37b95f25c01d6039a58613a077a1e12e2908aab5"
        );
        ...
        assert_eq!(
            tx.txid,
            Hash256::new(
                &hex::decode("54bea622d987ad81b8f40d4032ac493d46b38b7b7c5d6adfa43e6df2e12d04fb")
                    .unwrap()
            )
        );
        assert_eq!(
            tx.wtxid,
            Hash256::new(
                &hex::decode("99f6715bb7e45c894833ddf39556a6abe088daae36ae676266d9df7bac2c62f4")
                    .unwrap()
            )
        );
        assert_eq!(tx.version, 2);
        ...
        test_input!(
            &inputs[0],
            "9715af8a302c0cd4e61bfc36dd07e121587ae0a658aa282221620d0731759308",
            7,
            "1600144d3e60e105bfa848ecee7a5c3ce3813daea667d1",
            4294967295
        );
        test_input!(
            &inputs[1],
            "9ce8f610df9690fb2984db5899a9b2682f65ece021e6a31d826c9c8a0f48946e",
            0,
            "160014e1cd4fddae7903830809211dafc8b7d8ab5afa32",
            4294967295
        );
        test_input!(
            &inputs[2],
            "a0f144c434bf1ad4d9e98e0bc0209f2ac28037788741d15db8f12d0c085fe362",
            1,
            "160014f7bae6ee31d59e79da8e857fb63429637f9e0d57",
            4294967295
        );
        ...
        test_output!(
            outputs[0],
            2500000,
            "76a9147e7622d8d0efdb8d70ce09778dbbbf458459dec388ac"
        );
        test_output!(
            outputs[1],
            203232,
            "a914f03e6bf9b389bbd5d5669ff55c4dba30de99553587"
        );
        ...
        test_witness!(
            &witnesses_n[1],
            "036ae671cef76a3d484b870750035732dbe1b375e63025bc4d41c497c88dfe0250"
        );
        let witnesses_n = &witnesses[1];
        ...
        test_witness!(
            &witnesses_n[1],
            "02b4ef840cdc831ba64efa3148658c9846edc9a6d46135afad22e8cfe0ebdda13c"
        );
        let witnesses_n = &witnesses[2];
