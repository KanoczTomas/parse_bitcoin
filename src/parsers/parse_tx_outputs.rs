...
pub fn parse_tx_outputs(input: &[u8]) -> IResult<&[u8], (Vec<TxOutput>, usize)> {
    ...
    for _ in 0..out_count {
        let (i, (value, script_pub_key)) = tuple((le_u64, length_data(parse_var_int)))(input)?;
        input = i;
        vec.push(
            TxOutputBuilder::new()
                .value(value)
...
mod test {
    ...
    fn test_parse_tx_outputs() {
        ...
        test_output!(
            outputs[0],
            7357023,
            "a91430897cc6c9d69f6a2c2f1c651d51f22219f1a4f687"
        );
        test_output!(
            outputs[1],
            28734702,
            "a914fa68aba99b21ce4bba393eacc17305fe12f9021b87"
        );
    }
}
